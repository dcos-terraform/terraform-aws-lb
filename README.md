...
============
This module creates Application and Network Load Balancers. Be aware that Application supports only "HTTP" and "HTTPS" whereas Network only supports "TCP" and "UDP"
